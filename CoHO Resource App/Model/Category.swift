...
class Category: OrganizationalLevel, NSCoding {
	// MARK NSCoder
	...
	/// A category object loaded from JSON will not contain resources. Need to load resources after all resources are loaded.
	func loadResources(fromAllResources allResources: [Resource]) {
		for resource in allResources {
			if resource.categoryIDs.contains(self.id) {
